...
# start_food = df[df['Year'] == df['Year'].min()]['CPI_Food'].mean()
# end_food = df[df['Year'] == df['Year'].max()]['CPI_Food'].mean()
# percent_increase_food = ((end_food - start_food) / start_food) * 100
# print(f"CPI_Food increased by {round(percent_increase_food, 2)}% over the period.")
